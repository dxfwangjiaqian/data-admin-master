<template>
  <detail :content="content" @download="download" @review="review"></detail>
</template>

<script>
import Detail from "_c/detail/index.js";
export default {
